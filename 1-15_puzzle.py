...
def main():
    ...
    RESET_SURF, RESET_RECT = makeText('Reset',    TEXT, BGCOLOR, win_width - 150, win_height - 310)
    NEW_SURF,   NEW_RECT = makeText('New Game', TEXT, BGCOLOR, win_width - 150, win_height - 280)
    SOLVE_SURF, SOLVE_RECT = makeText('Solve',    TEXT, BGCOLOR, win_width - 150, win_height - 250)
